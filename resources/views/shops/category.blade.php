            ...
            <div class="col-md-4">
                ...
                <div class="list-group">
                    ...
                    @foreach ($categories as $cat)
                        <a href="{{ route('shops.category', $cat->slug) }}" class="list-group-item list-group-item-action">{{ $cat->name }}</a>
                    @endforeach
                </div>
            </div>
            <div class="col-md-8">
                <h2 style="font-size: 22px" class="mb-3">Kategori {{ $category->name }}</h2>
                <div class="row">
