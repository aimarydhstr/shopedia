                    ...
                    @foreach ($products as $product)
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('shops.category', $product->category->slug) }}" class="card-text text-decoration-none fw-bold text-uppercase" style="font-size: 11px">{{ $product->category->name }}</p>
